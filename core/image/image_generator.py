...
TEMPLATE_FIELDS = {
    # Amharic Fields
    "name_am": {"type": "text", "coords": (242, 104), "lang": "am", "size": 18},
    "date_of_birth_et": {"type": "text", "coords": (242, 183), "lang": "am", "size": 16},
    "sex_am": {"type": "text", "coords": (242, 220), "lang": "am", "size": 16},
    ...
    "name_en": {"type": "text", "coords": (242, 126), "lang": "en", "size": 18},
...
def generate_final_id_image(
    ...
    **kwargs
    ...
    Args:
        ...
        text_data: Optional pre-extracted or edited text dictionary
        flip: True to mirror/flip horizontally (for PVC reverse printing)
    ...
    if target_size == (2042, 638) or target_size is None:
        front_large = img_large.crop((0, 0, 631 * scale, h * scale))
        back_large = img_large.crop((660 * scale, 0, w * scale, h * scale))
